...
let pkg = `{
  ...
  "homepage1": "\${4:\${homepage=this is a placeholder}}",
  ...
  "bugs": {
    ...
    "url2": "https://github.com/\${7:#{owner=\${6:\${author.abc=\${bar=\${baz}}}}}}/\${1:name}/issues"
    "url3": "https://github.com/\${7:#{owner=\${6:\${author.def}}}}/\${1:name}/issues"
  },
  "files": "$TM_FILEPATH",
  "engines": {
    "node": ">=\${8:\${engine:10}}"
...
let fn = await compile(ast, { helpers });
